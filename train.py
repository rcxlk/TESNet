...
# from M_DSTCFNet_nets.DSTCFNet import DSTCFNet as DSTCFnet
# from S_SANet_nets.SA import SABody as SAnet
# # from M_Tridos_nets.slowfastnet_9520 import slowfastnet as Tridos
# # from M_DTUM_nets.model_DNANet import DNANet_DTUM as DTUMnet
...
# from M_DSTCFNet_nets.DSTCFNet_3DSTF1 import DSTCFNet as DSTCFnet_3DSTF1
# from M_DSTCFNet_nets.DSTCFNet_3DST import DSTCFNet as DSTCFnet_3DST
# # from M_DTUM_nets.layers import DTUM  as DTUMnet
# from S_MTUNet_nets.MTUNet import MTUNet as MTUnet
# from M_LVNet_nets.model import LVNet as LVnet
...
from M_TMPNet_nets.yolo_training import (ModelEMA, YOLOLoss, get_lr_scheduler,
...
if __name__ == "__main__":
    ...
    # model_path = 'logs_TESNet_param/loss_2025_09_11_17_53_09/ep030-loss5.242-val_loss7.810.pth'
    # model_path      = 'logs_RDIANNet/loss_2025_06_06_05_29_53/best_epoch_weights.pth'
    # model_path = 'logs_SANet/loss_2025_06_05_08_10_40/ep080-loss5.242-val_loss16.322.pth'
    # model_path = 'logs_TridosNet/loss_2025_06_08_15_25_02/best_epoch_weights.pth'
    #------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs_ISTDUNet_real_sim'
    #------------------------------------------------------------------#
    ...
    train_annotation_path = r'D:\rcx-code\DetectionCode\SIMDataSet_allSimData\coco_utils\coco_train_linux.txt'
    val_annotation_path = r'D:\rcx-code\DetectionCode\SIMDataSet_allSimData\coco_utils\coco_val_linux.txt'
    # train_annotation_path = r'E:\code\rcx_code\target_detection\DAUB\coco_utils\train_DAUB.txt'
    # val_annotation_path = r'E:\code\rcx_code\target_detection\DAUB\coco_utils\val_DAUB.txt'
    ...
    # model = ACMnet_FPN(num_classes=1)
    # model = DTUMnet(num_classes=1, num_frames=5)
    # model = DSTCFnet_BS(num_classes=1, num_frame=num_frame)
    # model = DSTCFnet_BST(num_classes=1, num_frame=num_frame)
    # model = SAnet(num_classes=1)
    # model = Tridos(num_classes=1, num_frame=5)
    # model = MTUnet(num_classes=1)
    # model = LVnet(num_classes=1, num_frame=num_frame)

    # model = DSTCFnet_3DSTF_ablation(num_classes=1, num_frame=num_frame)
    # model = TMPnet(num_classes=1, num_frame=num_frame)
    model = ISTDUnet(num_classes=1, in_channels=3)
    ...
    if True:
        ...
        #---------------------------------------#
        pg0, pg1, pg2 = [], [], []  # pg0: BN.weight, pg1: Conv/Linear weight, pg2: bias
